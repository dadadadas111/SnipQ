...
export function AcceptSelectedSuggestion() {
  return window['go']['main']['App']['AcceptSelectedSuggestion']();
}
...
export function IsSuggestionsEnabled() {
  return window['go']['main']['App']['IsSuggestionsEnabled']();
}
...
export function SelectNextSuggestion() {
  return window['go']['main']['App']['SelectNextSuggestion']();
}

export function SelectPreviousSuggestion() {
  return window['go']['main']['App']['SelectPreviousSuggestion']();
}
...
export function SetSuggestionsEnabled(arg1) {
  return window['go']['main']['App']['SetSuggestionsEnabled'](arg1);
}
